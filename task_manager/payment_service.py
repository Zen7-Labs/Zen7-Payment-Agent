...
class PaymentService:
    ...
    async def sign_for_payment(self):
        ...
        signature, r, s, v = sign(budget=budget, deadline=deadline, network=network, token=token)
    ...
    async def do_permit_and_transfer(self):
