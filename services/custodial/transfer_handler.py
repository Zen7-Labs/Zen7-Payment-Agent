...
from services import CHAIN_ID, CHAIN_RPC_URL, USDC_ADDRESS
import os
...
class TransferHandler:
    ...
    async def execute_transfer_from(
        ...
        try:
            ...
            transfer_txn = self.usdc_contract.functions.transferFrom(
                ...
                self.account.address,  # to (spender - your CDP sub-account)
                int(amount)            # amount
            ).build_transaction({
    ...
    async def execute_permit(
        ...
        try:
            ...
            logger.info(f" Web3 permit execution failed: {str(e)}")
            return {
                "success": False,
                "error": str(e),
    ...
    def simulate_permit(self, owner, spender, value, deadline, v, r, s):
        ...
        try:
            ...
            # Only return human-readable revert reason
