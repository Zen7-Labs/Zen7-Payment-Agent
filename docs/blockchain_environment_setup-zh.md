...
| **Base Sepolia** | `0x14a34` | `84532` | ⭐⭐⭐ 推荐 |
| **Polygon Amoy** | `0x13882` | `80002` | ⭐⭐ 可选 |
| **BNB Chain Testnet** | `0x61` | `97` | ⭐⭐ 可选 |
| **Solana Devnet** | N/A | N/A | ⭐⭐⭐ 推荐 |

> **推荐网络**：
> - **EVM 链**：Ethereum Sepolia 和 Base Sepolia - 网络成熟稳定、测试代币获取方便、文档资源丰富。
> - **Solana**：Solana Devnet - 确认速度快、费用低廉、开发者体验优秀。

### 1.2 网络特性对比

| 特性 | Ethereum Sepolia | Base Sepolia | Polygon Amoy | BNB Testnet | Solana Devnet |
|-----|-----------------|--------------|--------------|-------------|---------------|
| Gas 费用 | 较高 | 较低 | 低 | 很低 | 极低 |
| 网络稳定性 | 非常高 | 较高 | 较高 | 较高 | 非常高 |
| 测试代币获取 | 容易 | 一般 | 一般 | 容易 | 容易 |
| 区块确认时间 | ~12 秒 | ~2 秒 | ~2 秒 | ~3 秒 | ~400毫秒 |
| 社区支持 | 最好 | 良好 | 良好 | 良好 | 优秀 |
| 代币标准 | ERC-20 | ERC-20 | ERC-20 | BEP-20 | SPL Token |
