        ...
        try:
            ...
            session = await self.runner.session_service.create_session(
                ...
                state={
                    ...
                    "sign_info": context.message.metadata["sign_info"],
                    "owner_wallet_address": context.message.metadata["owner_wallet_address"],
                    "payment_info": context.message.metadata["payment_info"],
                    "timezone": context.message.metadata["timezone"]
                },
